...
const Featured = () => {
    return (
        <div className='bg-[#F6F9F8]'>
            <div id='features' className='max-w-[1140px] mx-auto px-4 w-full xl:px-0 py-14 md:py-16 lg:py-20 xl:py-[100px]'>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 items-center">
                    <div className='order-2 md:order-1 pt-2 md:pt-0'>
                        <TagBox border >featured</TagBox>
                        <Heading className={"pt-5 pb-3 lg:max-w-[420px]"} left>LEARN SMARTER WITH TOMOHI</Heading>
                        ...
                        <p className='text-[#676666] pt-2 flex gap-4 max-w-[484px] w-full text-base leading-150'>
                            <span className='block h-1 w-1 p-[1px] ms-2 bg-[#676666] mt-2.5 rounded-full'></span>
                            Connect 1-on-1 with experienced mentors
                        </p>
                        <p className='text-[#676666] pt-2 flex gap-4 max-w-[484px] w-full text-base leading-150'>
                            <span className='block h-1 w-1 p-[1px] ms-2 bg-[#676666] mt-2.5 rounded-full'></span>
                        ...
                        <p className='text-[#676666] pt-2 flex gap-4 max-w-[484px] w-full text-base leading-150'>
                            <span className='block h-1 w-1 p-[1px] ms-2 bg-[#676666] mt-2.5 rounded-full'></span>
                            Earn certifications and skill badges
                        </p>
